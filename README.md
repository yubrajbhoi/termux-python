...
This is a fork of Python-3.14.4 with Termux patches (`termux.patch`) applied.
...
After that the package can be build with: `bash build.sh`. That will build and install it in `python-3.14.4` directory.
...
### DEB Packages
 ...
 - [python314_3.14.4_aarch64.deb](https://public.8018985.xyz/python314_3.14.4_aarch64.deb)
 - [python314t_3.14.4_aarch64.deb](https://public.8018985.xyz/python314t_3.14.4_aarch64.deb)

### Stow packages

 - [python_3.14.4_aarch64.tar.zst](https://public.8018985.xyz/python_3.14.4_aarch64.tar.zst)
 - [python_3.14.4t_aarch64.tar.zst](https://public.8018985.xyz/python_3.14.4t_aarch64.tar.zst)
